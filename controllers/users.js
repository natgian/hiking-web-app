...
module.exports.renderRegister = (req, res) => {
  res.render("users/register", { title: "Sign Up | Switzerland Explored", page_name: "register", site_key: siteKey });
};

// REGISTER NEW USER
module.exports.registerUser = async (req, res, next) => {
  try {
    const { email, username, password, "cf-turnstile-response": token } = req.body;
    ...
    req.login(registeredUser, (err) => {
      // logging in the user automatically after he has signed up
...
module.exports.sendResetPasswordEmail = async (req, res, next) => {
  ...
  const mailOptions = {
    ...
    text:
      `You are receiving this message because a password reset has been requested for your account on SwitzerlandExplored.\n\n` +
